...
#elif defined(TINY_GSM_MODEM_SIM7672S)
#include "TinyGsmClientSIM7672S.h"
typedef TinyGsmSim7672S                   TinyGsm;
typedef TinyGsmSim7672S::GsmClientSim7672S TinyGsmClient;
